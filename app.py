...
# --- CONFIGURAZIONE ---
st.set_page_config(page_title="Grid Master Console v5.10.2", layout="wide")
...
with col_logo:
    st.image("logo-fp-piccolo.png", width=80) 

with col_titolo:
    # Usiamo markdown con HTML per avere il nome grande e la versione piccola
    st.markdown('<h1 style="margin-bottom: 0;">Grid Master <span style="font-size: 16px; color: gray; font-weight: normal;">v5.10.2</span></h1>', unsafe_allow_html=True)
